                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="bukti-image-container position-relative">
                            <img src="http://192.168.79.206:8080/uploads/bukti_pembayaran/{{ $pesanan['bukti_pembayaran'] }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3">
                            <a href="http://192.168.79.206:8080/uploads/bukti_pembayaran/{{ $pesanan['bukti_pembayaran'] }}" 
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="bukti-image-container position-relative">
                            <img src="http://192.168.79.206:8080/uploads/bukti_pengiriman/{{ $pesanan['bukti_pengiriman'] }}" 
                                 class="img-fluid rounded shadow-sm" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3">
                            <a href="http://192.168.79.206:8080/uploads/bukti_pengiriman/{{ $pesanan['bukti_pengiriman'] }}" 
...
<div class="modal fade" id="buktiPengirimanModal" tabindex="-1">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-0">
                <img src="http://192.168.79.206/uploads/bukti_pengiriman/{{ $pesanan['bukti_pengiriman'] }}" 
                     class="img-fluid" 
                     alt="Bukti Pengiriman"
                     style="max-height: 80vh; width: auto;">
            </div>
            <div class="modal-footer border-0">
                <a href="http://192.168.79.206/uploads/bukti_pengiriman/{{ $pesanan['bukti_pengiriman'] }}" 
